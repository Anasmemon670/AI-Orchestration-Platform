...
SECRET_KEY = 'django-insecure-*ob#c%%ft@-f0!fq!nhj(^o=oaxt4tb^ciwe(og3p%#8o_ftaq'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Can add templates folder later if needed
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'neondb',
        'USER': 'neondb_owner',
        'PASSWORD': 'npg_3ColJGRqduj2',
        'HOST': 'ep-sweet-butterfly-ahblg8m4-pooler.c-3.us-east-1.aws.neon.tech',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
        },
